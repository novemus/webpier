...
BOOST_AUTO_TEST_CASE(client)
{
    ...
    webpier::service foo { true, "foo", peer, "127.0.0.1:1234", webpier::default_ip4_gateway, webpier::default_dht_bootstrap, wormhole::protocol::udp, wormhole::schema::either, plexus::routing::either, true, false };
    webpier::service bar { true, "bar", peer, "127.0.0.1:5678", webpier::default_ip4_gateway, webpier::default_dht_bootstrap, wormhole::protocol::udp, wormhole::schema::either, plexus::routing::either, true, false };
